...
// https://registry.terraform.io/providers/hashicorp/helm/3.2.0/docs
...
export class HelmProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing HelmProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/helm/3.2.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/helm/3.2.0/docs helm} Resource
  *
  * @param scope The scope in which to define this construct
