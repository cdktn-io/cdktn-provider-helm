...
// https://registry.terraform.io/providers/hashicorp/helm/3.3.0/docs/data-sources/template
...
export class DataHelmTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHelmTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/helm/3.3.0/docs/data-sources/template#import import section} in the documentation of this resource for the id to use
